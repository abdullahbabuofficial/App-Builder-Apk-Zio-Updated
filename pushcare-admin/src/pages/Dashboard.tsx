    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          deltaPct={2.1}
          hint={`/ ${compact(totals.installs)} installs`}
          trailing={<Sparkline data={installs.slice(-14)} color="#7CB7FF" width={72} height={36} />}
        />
        <StatCard
          label="Pushes sent · 7d"
          value={compact(totals.sent / 26)}
          deltaPct={-1.2}
          hint="rolling 7-day"
          trailing={<Sparkline data={installs.slice(-14)} color="#5DCFA3" width={72} height={36} />}
        />
        <StatCard
          label="Delivery rate"
          value="98.4"
          ...
          deltaPct={0.3}
          hint="p99 245ms"
          trailing={<Sparkline data={installs.slice(-14)} color="#FF8A4C" width={72} height={36} />}
        />
      </div>
                    ...
                    <tr key={a.id} className="border-b border-line-1/70 last:border-b-0 hover:bg-ink-2/60">
                      ...
                      <td className="px-5 py-3">
                        <div className="ml-auto w-fit">
                          <Sparkline data={dailyInstalls(14, a.id)} color={a.status === "paused" ? "#FFB547" : "#CDFF3F"} width={88} height={28} />
                        </div>
                      </td>
                    </tr>
                  ))}
