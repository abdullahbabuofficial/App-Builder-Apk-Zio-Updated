 ...
 *
 * Optional env:
 *   CREATE_ADMIN_EMAIL (default test@pushcare.net)
...
const email = (process.env.CREATE_ADMIN_EMAIL || "test@pushcare.net").trim().toLowerCase();
...
if (!url || !serviceKey) {
  console.error(
    "Missing configuration.\n" +
      ...
      "  • Set SUPABASE_URL or VITE_SUPABASE_URL in backends/.env or pushcare-admin/.env\n",
  );
  process.exit(1);
}
