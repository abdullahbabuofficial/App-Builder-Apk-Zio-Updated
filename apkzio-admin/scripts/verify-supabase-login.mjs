...
const email = (process.env.TEST_LOGIN_EMAIL || "test@apkzio.net").trim().toLowerCase();
const password = process.env.TEST_LOGIN_PASSWORD || "Test@123";

if (!url || !anon) {
  console.error("Missing VITE_SUPABASE_URL or VITE_SUPABASE_ANON_KEY in apkzio-admin/.env");
  process.exit(1);
}
